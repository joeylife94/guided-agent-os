...
def main() -> int:
    ...
    parser.add_argument("--output", default="artifacts/proof-eval-results.json")
    parser.add_argument(
        "--skip-index-rebuild",
        action="store_true",
    ...
    print(json.dumps({key: result[key] for key in ("suite", "total", "passed", "failed", "all_passed")}, indent=2))
